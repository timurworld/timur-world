...
export const characters: Character[] = [
  ...
  { slug: "lovini-lovini-sahur",  name: "Lovini Lovini Sahur",   number: 16, series: "lovini",    spriteUrl: "/characters/16_love_love_love_sahur.png", sketchUrl: "/sketches/16_love_love_love_sahur.png",  facts: ["Spells LOVE so big you can read it from space"],                     mult: "7.2x", rarity: "rare",      status: "released" },
  { slug: "chiclitera-cupidini",  name: "Chiclitera Cupidini",   number: 17, series: "lovini",    spriteUrl: "/characters/17_chiclitera_cupidini.png", sketchUrl: "/sketches/17_chiclitera_cupidini.png",   facts: ["The fiercest cupid in the arena — never misses"],                    mult: "7.4x", rarity: "legendary", status: "released" },
  ...
  // ── Fidgetini ──
  { slug: "yessini-innovarini",   name: "Yessini Innovarini",    number: 14, series: "fidgetini", spriteUrl: "/characters/14_yes_my_innovar.png", sketchUrl: "/sketches/14_yes_my_innovar.png",           facts: ["Says YES to every new invention idea"],                              mult: "6.8x", rarity: "standard", status: "released" },
