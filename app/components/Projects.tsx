...
const projects: Project[] = [
  ...
  { title: "Timur World Arena", category: "Backgrounds" as const, image: "/worlds/bg_24.jpg?v=2", emoji: "🏒", description: "Timur World's flagship hockey arena — home of the Maple Cup and Cupideini Hockini.", glow: "#ffd700", featured: true },
  ...
  { title: "Toy Workshop", category: "Backgrounds" as const, image: "/worlds/bg_04.jpg", emoji: "🧸", description: "Teddini & Robotini's cozy workshop full of toys and gears.", glow: "#c8894f", featured: false },
  { title: "Fireworks Night", category: "Backgrounds" as const, image: "/worlds/bg_05.jpg", emoji: "🎆", description: "Noobini Partini's celebration under a sky of fireworks.", glow: "#ff6347", featured: false },
  { title: "Bakery Kitchen", category: "Backgrounds" as const, image: "/worlds/bg_06.jpg", emoji: "🧁", description: "Cakini Presintini's magical kitchen of cakes and treats.", glow: "#ff8c00", featured: false },
  { title: "Rose Garden", category: "Backgrounds" as const, image: "/worlds/bg_07.jpg", emoji: "🌹", description: "Lovini Rosetti's beautiful garden bursting with roses.", glow: "#db7093", featured: false },
  { title: "Cloud Kingdom", category: "Backgrounds" as const, image: "/worlds/bg_08.jpg", emoji: "☁️", description: "Heartini Sorrissoni's dreamy floating clouds and rainbows.", glow: "#40c4c4", featured: false },
  { title: "Dark Battle Arena", category: "Backgrounds" as const, image: "/worlds/bg_09.jpg", emoji: "⚔️", description: "Transformini Firini's epic arena with fire pillars.", glow: "#e63900", featured: false },
  { title: "Celestial Temple", category: "Backgrounds" as const, image: "/worlds/bg_10.jpg", emoji: "🌙", description: "Cupidini Sahuroni's floating temple under the moon.", glow: "#ff1493", featured: false },
  { title: "Enchanted Forest", category: "Backgrounds" as const, image: "/worlds/bg_11.jpg", emoji: "🍄", description: "Rositti Tueletti's magical forest with glowing mushrooms.", glow: "#ba55d3", featured: false },
  { title: "Birthday Party", category: "Backgrounds" as const, image: "/worlds/bg_12.jpg", emoji: "🎈", description: "Birthdayini Cardini's golden celebration room.", glow: "#ffd700", featured: false },
  { title: "Circus Tent", category: "Backgrounds" as const, image: "/worlds/bg_13.jpg", emoji: "🎪", description: "Cakini Elephantini's magical circus with spotlights.", glow: "#9b8ec4", featured: false },
  { title: "Inventor Lab", category: "Backgrounds" as const, image: "/worlds/bg_14.jpg", emoji: "💡", description: "Yessini Innovarini's futuristic workshop with holograms.", glow: "#3498db", featured: false },
  { title: "Jungle Party", category: "Backgrounds" as const, image: "/worlds/bg_15.jpg", emoji: "🌴", description: "Noobini Partyini's tropical jungle celebration.", glow: "#2ecc71", featured: false },
  { title: "Ocean Sunset", category: "Backgrounds" as const, image: "/worlds/bg_16.jpg", emoji: "🌅", description: "Lovini Lovini Sahur's peaceful ocean at golden hour.", glow: "#5dade2", featured: false },
  { title: "Crimson Arena", category: "Backgrounds" as const, image: "/worlds/bg_17.jpg", emoji: "🔥", description: "Chiclitera Cupidini's fiery battlefield.", glow: "#dc143c", featured: false },
  { title: "Rainy Night", category: "Backgrounds" as const, image: "/worlds/bg_18.jpg", emoji: "🌧️", description: "Noo Mio Heartini's moody midnight rain.", glow: "#8b0000", featured: false },
  { title: "Volcano Throne", category: "Backgrounds" as const, image: "/worlds/bg_19.jpg", emoji: "🌋", description: "Cupidini Hotspottini's epic lava kingdom.", glow: "#ff4500", featured: false },
  { title: "Hockey Rink", category: "Backgrounds" as const, image: "/worlds/bg_20.jpg", emoji: "🏒", description: "The Sportini crew's ice arena — home of Stick Stick, No My Pucks & Hockey Bros.", glow: "#00d4ff", featured: false },
  { title: "Citrus Oasis", category: "Backgrounds" as const, image: "/worlds/bg_21.jpg", emoji: "🍊", description: "Kingurini Orangini's tropical orange grove with waterfalls and paw banners.", glow: "#ff8c00", featured: false },
  { title: "Neon Berry City", category: "Backgrounds" as const, image: "/worlds/bg_22.jpg", emoji: "🍓", description: "Auraberry's electric skyline lit by neon strawberries and stars.", glow: "#a259ff", featured: false },
  { title: "Sushi Sunset", category: "Backgrounds" as const, image: "/worlds/bg_23.jpg", emoji: "🍣", description: "Sushiro & Soyaro's torii-gated sushi shop at golden hour.", glow: "#ff6f61", featured: false },
];
