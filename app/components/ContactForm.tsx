...
export default function ContactForm() {
  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4 max-w-lg">
      ...
      <button
        type="submit"
        className="px-6 py-3.5 bg-ink text-white font-[family-name:var(--font-collector)] font-bold text-xs uppercase tracking-wider hover:bg-ink/90 transition-colors"
      >
        Send message
      </button>
    </form>
